package com.jen.kafka.libraryeventproducer.producers;
...
public class LibraryEventProducer {
	...
	public ListenableFuture<SendResult<String,String>> sendLibraryEvent_Approach2(LibraryEvent libraryEvent) throws JsonProcessingException {
	...
	private ProducerRecord<String, String> buildProducerRecord(String key, String value, String topic) {
		...
		List<Header> recordHeaders = List.of(new RecordHeader("event-source", "spring-micro-service".getBytes()));
	...
	public SendResult<String, String> sendLibraryEventSynchronous(LibraryEvent libraryEvent) throws JsonProcessingException, ExecutionException, InterruptedException, TimeoutException {
		...
		try {
			...
			sendResult = kafkaTemplate.sendDefault(key,value).get(200, TimeUnit.SECONDS);
